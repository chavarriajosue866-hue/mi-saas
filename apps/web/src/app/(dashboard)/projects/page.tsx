...
import { Loader2, Plus, Users, Copy, Check, FolderOpen } from "lucide-react";
...
export default function ProjectsPage() {
  ...
  const handleJoinProject = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(error.message || "Error joining project");
    } finally {
      setIsJoining(false);
    }
  };
      ...
      {showCreateForm && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Create a project and invite others with a unique code
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      {showJoinForm && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Enter the project code to join
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleJoinProject} className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="joinCode">Project Code</Label>
                <Input
                  id="joinCode"
                  value={joinCode}
